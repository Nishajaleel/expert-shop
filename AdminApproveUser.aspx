 ...
 <div class="col-md-12">
         ...
         <asp:DataList ID="DataList1" runat="server" DataKeyField="userid" onselectedindexchanged="DataList1_SelectedIndexChanged" >
            ...
            <ItemTemplate>
               ...
               <td>
                 <asp:Button class="fa fa-download" ID="btn1" Height="32px" Width="100px" BackColor="#182B3E"  BorderColor="White" BorderStyle="None" ForeColor="White" runat="server" CommandName="Select"  Text="Approve" /> 
               </td>
            </tr>
