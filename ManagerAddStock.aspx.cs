...
public partial class ManagerAddStock : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            ob.dr = ob.ret_dr("select * from stock where pid=" + TextBox8.Text + "");
             if (ob.dr.Read())
             {
                 TextBox17.Text = ob.dr[0].ToString();
                 TextBox18.Text=ob.dr[6].ToString();
                 cstock = Convert.ToInt32(TextBox18.Text);
    ...
    {
        tstock = cstock + Convert.ToInt32(TextBox18.Text);
        ob.exec("update stock set stock =" + tstock + " where stockid=" + TextBox17.Text + "");
        ScriptManager.RegisterStartupScript(this, this.GetType(), "message", "alert('Stock Added Successfully');", true);
        TextBox19.Text = "";
        TextBox20.Text = "";
        TextBox3.Text = "";
        TextBox6.Text = "";
