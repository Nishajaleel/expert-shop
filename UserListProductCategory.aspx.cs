...
public partial class UserListProductCategory : System.Web.UI.Page
{
    ...
    int pg = 0;
    protected void BindData(string m)
    {
        CurrentPageIndex = 0;
        ds.Tables.Clear();
        PagedDataSource pgd = new PagedDataSource();
        string cmdstr = "Select * from product where subcat='"+m+"' and status=0";
