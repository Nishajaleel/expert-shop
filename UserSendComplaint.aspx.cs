...
public partial class UserSendComplaint : System.Web.UI.Page
{
    ...
    public void pub()
    {
        ...
        try
        {
            string str = "select compid,sub,msg,date1,reply,date2 from complaint where status=1 and suname='" + uuname + "'";
            ds = pubdoc(str);
            if (ds != null)
            {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                ob.exec("insert into complaint values(" + TextBox2.Text + ",'" + uuname + "','" + runame + "','" + sub + "','" + mesg + "','" + date1 + "','" + reply + "','" + date2 + "','" + status + "')");
