...
public partial class InstitutionRegistration : System.Web.UI.Page
{
    ...
    {
        int c = 0;
        ob.dr = ob.ret_dr("select isnull(max(inid),600)+1 from iregister");
        if (ob.dr.Read())
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!ob.dr.Read())
            {
                ob.exec("insert into iregister values(" + uid + ",'" + TextBox1.Text + "','" + TextBox13.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox6.Text + "','" + DropDownList6.SelectedItem.ToString() + "','" + TextBox7.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "','" + TextBox12.Text + "','" + DropDownList7.SelectedItem.ToString() + "','" + TextBox8.Text + "','" + TextBox4.Text + "','" + dob + "',0)");
