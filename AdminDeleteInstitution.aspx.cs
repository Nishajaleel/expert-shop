...
public partial class AdminDeleteInstitution : System.Web.UI.Page
{
    ...
    public void pub()
    {
        ...
        try
        {
            string str = "select * from iregister where status=1";
            ds = pubdoc(str);
            if (ds != null)
            {
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ob1.exec("update iregister set status=2 where inid=" + c + "");
