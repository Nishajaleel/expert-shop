<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMasterPage.master" AutoEventWireup="true" CodeFile="ManagerUpdateProduct.aspx.cs" Inherits="ManagerUpdateProduct" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<h5>Manger Update Product </h5>
 ...
 <div class="form-w3agile form1">
        ...
        <asp:TextBox ID="TextBox20" runat="server" Width="350px" Height="30px" 
            Enabled="False"></asp:TextBox>
            <br />  
         <br />
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        <asp:TextBox 
             ID="TextBox2" runat="server" Width="700px" Height="30px" ></asp:TextBox>
             <br />
        <br />
        ...
        <asp:TextBox ID="TextBox12" runat="server" Width="350px" Height="30px" ></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox14" runat="server" Width="350px" Height="30px" ></asp:TextBox>
             
        <asp:TextBox 
             ID="TextBox15" runat="server" Width="350px" Height="30px" ></asp:TextBox>
             <br />
        <br />
        ...
        <asp:TextBox ID="TextBox9" 
                 runat="server" Width="700px" Height="100px" TextMode="MultiLine"></asp:TextBox>
             <br />
         <br />
        ...
        <br />
         <asp:Button 
                 ID="Button4" runat="server" Height="45px" Text="Update Product"  class="primary-btn cta-btn"  BackColor="#182B3E" BorderStyle="None" 
              ForeColor="White"  
        Width="200px" onclick="Button4_Click"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
                 ID="Button1" runat="server" Height="45px" Text="Delete Product"  class="primary-btn cta-btn"  BackColor="#182B3E" BorderStyle="None" 
              ForeColor="White"  
        Width="200px" onclick="Button1_Click"/>  <br /> 
        <br />
            <div>
