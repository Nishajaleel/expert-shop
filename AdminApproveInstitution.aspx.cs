...
public partial class AdminApproveInstitution : System.Web.UI.Page
{
    ...
    public void pub()
    {
        ...
        try
        {
            string str = "select * from iregister where status=0";
            ds = pubdoc(str);
            if (ds != null)
            {
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ob1.exec("update iregister set status=1 where inid=" + c + "");
        ob1.exec("update Login set status=3 where uid=" + c + "");
